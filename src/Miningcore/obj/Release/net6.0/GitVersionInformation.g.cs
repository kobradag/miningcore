...
static class GitVersionInformation
{
    ...
    public static string FullBuildMetaData = "Branch.main.Sha.602269ff626506228f38d5b02e8d97db49713c1c";
    public static string MajorMinorPatch = "0.2.6";
    public static string SemVer = "0.2.6";
    public static string LegacySemVer = "0.2.6";
    public static string LegacySemVerPadded = "0.2.6";
    public static string AssemblySemVer = "0.2.6.0";
    public static string AssemblySemFileVer = "0.2.6.0";
    public static string FullSemVer = "0.2.6";
    public static string InformationalVersion = "0.2.6+Branch.main.Sha.602269ff626506228f38d5b02e8d97db49713c1c";
    public static string BranchName = "main";
    public static string EscapedBranchName = "main";
    public static string Sha = "602269ff626506228f38d5b02e8d97db49713c1c";
    public static string ShortSha = "602269f";
    public static string NuGetVersionV2 = "0.2.6";
    public static string NuGetVersion = "0.2.6";
    public static string NuGetPreReleaseTagV2 = "";
    public static string NuGetPreReleaseTag = "";
    public static string VersionSourceSha = "602269ff626506228f38d5b02e8d97db49713c1c";
    ...
    public static string CommitDate = "2025-01-29";
}
